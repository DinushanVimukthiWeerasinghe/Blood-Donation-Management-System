...
$Login_Button= new PrimaryButton("Login", "/user/login", "btn-red mx-1");
$Login_Button_sm= new MPrimaryButton("Login", "/user/login", "btn-red mx-1");
$Register_Button= new PrimaryButton("Register", "/user/register", "btn-red mx-1");
$Register_Button_sm= new MSecondaryButton("Register", "/user/register", "btn-red mx-1");
...
<div class="super-header">
    ...
    <div class="nav-logo g-flex g-flex-col">
        <div class="g-flex g-flex-col">
            ...
            <div class="nav-desc">
                <p class="text text-white"> Lorem ipsum dolor sit amet, consectetur adipisicing elit. Consequatur, esse?</p>
            </div>
        </div>
