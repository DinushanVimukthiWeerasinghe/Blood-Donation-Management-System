...
$image=new \App\view\components\Image\GeneralImage("https://source.unsplash.com/user/c_v_r/200x200","alt","circle");
$button=new \App\view\components\Button\PrimaryButton("Button","/manager");
