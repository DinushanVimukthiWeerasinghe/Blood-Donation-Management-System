...
INSERT INTO `Hospital_Staff` (`Officer_ID`, `Hospital_ID`, `Hospital_Name`) VALUES
('HP001', 'HP001', 'Awoth mala');
...
('HP001', 'PAmkaya', '816009256V', '2022-12-14');
...
INSERT INTO `staff_credential` (`uid`, `email`, `password`, `type_id`, `role`) VALUES
('HP001', 'test@email.com', '$2y$10$76ufa.OwBnIuR0ZnL4h4NOGvQYIE84ejJxizvEJeV26XHAihJRXbu', 'Hospital', 'role');
